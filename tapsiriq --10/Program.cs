...
///// 2-ci
//var list = debtors.FindAll(d => d.Email.Contains("rhyta.com")  == true);
...
////////////////////////////////////////////////////////////////////////////////////////
//3-cu
//var list1 = debtors.FindAll(d =>26<(2021- d.BirthDay.Year) && 36 > (2021 - d.BirthDay.Year));
...
////////////////////////////////////////////////////////////////////////////////////////
//4-cu
//var list2 = debtors.FindAll(d => d.Debt < 5000);
...
////////////////////////////////////////////////////////////////////////////////////////
//5-ci
//var list3 = debtors.FindAll(d => d.FullName.Length >18 && (d.Phone.Count(n=>n==7)>=2));
...
////////////////////////////////////////////////////////////////////////////////////////
//6-ci
//var list4 = debtors.FindAll(d =>d.BirthDay.Month== 12 || d.BirthDay.Month == 1 || d.BirthDay.Month == 2);
...
//var list5 = debtors.Select(d => d.Debt).ToList();
//var orta = list5.Sum() / list5.Count();
//var list = debtors.FindAll(d => d.Debt > orta);
//var list2 = list.OrderBy(s => s.Debt);
...
////////////////////////////////////////////////////////////////////////////////////////
//9-cu
//var list4 = debtors.FindAll((d=>d.Phone.Count(n => n == 8) == 0));
//foreach (var item in list4)
//{
//    Console.WriteLine(item.FullName.Substring(item.FullName.IndexOf(" ")) +"  "+ (2022-item.BirthDay.Year)+"   "+ item.Debt);
//}
////////////////////////////////////////////////////////////////////////////////////////
///11-ci
...
//var list5 = debtors.Select(d => d.Debt).ToList();
//Console.WriteLine(list5.Sum()  );

////////////////////////////////////////////////////////////////////////////////////////
/////16 ci
//var list4 = debtors.FindAll(d => d.BirthDay.Year >= 1941 && d.BirthDay.Year <= 1945);
//foreach (var item in list4)
//{
//    Console.WriteLine(item);
//}
...
////////////////////////////////////////////////////////////////////////////////////////
//20 ci tapsiriq
//var list6 = debtors.FindAll((d=>d.FullName.Count(d=>d=='s') >= 1 && d.FullName.Count(d => d == 'm') >= 1 && d.FullName.Count(d => d == 'i') >= 1 && d.FullName.Count(d => d == 'l') >= 1 && d.FullName.Count(d => d == 'e') >= 1));
//foreach (var item in list6)
//{
//    Console.WriteLine(item);
//}